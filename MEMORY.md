...
- OG lockup + transparent favicon ship. Preview image: `public/images/og-card.jpg` (large lockup). Pre-deploy snapshot in `backups/pre-deploy.og-favicon.*`. Rollback git SHA before this ship: `435e78d`.
