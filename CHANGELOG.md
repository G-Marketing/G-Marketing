...
- Share card uses the brand lockup (`og-card.jpg`, 1200×630) and the title `Advertising. Marketing. Growth.` Favicon is the globe on a transparent background. Rollback SHA: `435e78d`.
...
- Ticket 003: local light palette (white / cool gray, cobalt). Kicker: Local & Global marketing. Em dashes removed from public copy.
